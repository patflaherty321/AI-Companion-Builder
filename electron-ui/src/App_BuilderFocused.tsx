  ...
  return (
    <div className="app-container">
      ...
      <main className="main-content">
        ...
        {activeSection === 'builder-page' && (
          <div className="content-section">
            ...
            <div className="builder-page-container">
              <BuilderIntegration 
                model="page" 
                contentId="your-page-content-id"  // Replace with your actual Builder.io page ID
          ...
          <div className="content-section">
            ...
            <div className="component-showcase">
              <div className="component-item">
                ...
                <BuilderIntegration 
                  model="component" 
                  contentId="avatar-chat-interface"  // Replace with your component ID
              ...
              <div className="component-item">
                ...
                <BuilderIntegration 
                  model="component" 
                  contentId="avatar-selection-panel"  // Replace with your component ID
              ...
              <div className="component-item">
                ...
                <BuilderIntegration 
                  model="component" 
                  contentId="settings-dashboard"  // Replace with your component ID
        ...
        {/* Builder.io URL Component for Testing */}
        <div className="url-component-section">
